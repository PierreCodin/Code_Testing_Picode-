...
const BenefitsSection = () => {
  return (
    <section className="py-16 lg:py-24 px-4 lg:px-6 bg-white/30 backdrop-blur-sm">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12 lg:mb-16">
          <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold text-foreground mb-8">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="relative order-1 lg:order-1">
            ...
            {/* Animated decorations - hidden on mobile */}
            <div className="hidden lg:block absolute -top-4 -right-4 w-24 h-24 gradient-hero rounded-full opacity-20 blur-xl animate-pulse"></div>
            <div className="hidden lg:block absolute -bottom-4 -left-4 w-32 h-32 gradient-primary rounded-full opacity-15 blur-2xl animate-pulse delay-1000"></div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8">
              {[
                ...
                <div key={index} className="text-center space-y-2 group p-4 lg:p-6 bg-white/80 backdrop-blur-sm rounded-xl shadow-soft border border-primary/10 relative">
                  ...
                  <div className="text-muted-foreground font-medium relative z-10 text-sm lg:text-base">
                    {stat.label}
                  </div>
                </div>
              ))}
