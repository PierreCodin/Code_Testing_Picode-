...
const HeroSection = () => {
  return <section className="relative py-12 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div className="absolute bottom-2/3 left-1/6 w-6 h-6 border border-primary/30 rounded-full animate-spin" style={{
        ...
        <div className="absolute top-2/3 left-1/5 w-6 h-6 border border-primary/35 rotate-45 animate-spin delay-1800" style={{
      ...
      <div className="container mx-auto max-w-7xl relative px-0">
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              {["7 jours gratuits", "Pas de CB requise", "Sans Engagement", "Mise en place en 5min"].map((feature, index) => <div key={index} className="flex items-center space-x-3">
          ...
          <div className="relative flex justify-end">
            <div className="relative z-10 shadow-card rounded-2xl overflow-hidden bg-white aspect-[9/16] max-w-xs ml-20 video-neon-glow">
              <video src="https://pierrecodin.github.io/VideoRevwheel/VideoRevwheel.mp4" className="w-full h-full object-contain" controls controlsList="nodownload" preload="auto" muted playsInline onLoadStart={() => console.log('Video loading started')} onError={e => console.log('Video error:', e)} key="revwheel-video-final" style={{
              aspectRatio: '9/16'
            }} />
            </div>
        ...
        <div className="lg:hidden flex flex-col items-center space-y-6">
          ...
          <div className="w-full flex justify-center mb-4">
            <Button variant="hero" className="text-center font-bold" style={{
            width: '80%',
            height: '48px',
            borderRadius: '30px',
            fontSize: '16px',
          ...
          <div style={{
          marginLeft: '8%'
        }} className="w-full space-y-2 mb-3 px-[58px] py-[6px]">
            {["7 jours gratuits", "Pas de CB requise", "Sans Engagement", "Mise en place en 5min"].map((feature, index) => <div key={index} className="flex items-center space-x-3 px-[5px]">
                <div className="flex-shrink-0 rounded-full gradient-subtle flex items-center justify-center" style={{
              width: '16px',
              height: '16px'
            }}>
                  <Check className="text-primary" style={{
                width: '10px',
                height: '10px'
              }} />
                </div>
          ...
          <div className="w-full flex justify-center mt-8 mb-5">
            ...
            aspectRatio: '9/16'
              ...
              <video src="https://pierrecodin.github.io/VideoRevwheel/VideoRevwheel.mp4" className="w-full h-full object-contain" controls controlsList="nodownload" preload="auto" muted playsInline onLoadStart={() => console.log('Video loading started')} onError={e => console.log('Video error:', e)} key="revwheel-video-final-mobile" style={{
              aspectRatio: '9/16'
            }} />
            </div>
          </div>
